  ...
  return (
    <div className="mt-16 mb-12">
      ...
      <div className="w-full flex justify-center mb-8">
        <div className="w-24 h-0.5 bg-gradient-to-r from-[#2A3B4C] to-[#45B7D1] dark:from-[#3A7D8A] dark:to-[#56CFE1] rounded-full opacity-50"></div>
      </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg overflow-hidden transition-all duration-500 p-8 md:p-12 relative backdrop-blur-sm bg-opacity-60 dark:bg-opacity-40">
        {/* 渐变背景装饰 */}
        <div className="absolute inset-0 bg-gradient-to-r from-[#2A3B4C] to-[#45B7D1] dark:from-[#3A7D8A] dark:to-[#56CFE1] opacity-5"></div>
        ...
        <div className="flex items-center justify-between mb-8 relative z-10">
          <div className="flex items-center">
            <div className="w-8 h-8 bg-gradient-to-r from-[#2A3B4C] to-[#45B7D1] dark:from-[#3A7D8A] dark:to-[#56CFE1] rounded-lg flex items-center justify-center mr-3 shadow-md">
              <svg
          ...
          <Link
            href="/posts"
            className="cursor-target text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 text-sm font-medium transition-colors duration-300"
          >
            查看更多
          </Link>
        </div>
        ...
        <div className="absolute top-4 right-4 w-16 h-16 opacity-10 pointer-events-none">
          <svg viewBox="0 0 100 100" className="w-full h-full">
            <circle cx="20" cy="20" r="2" className="fill-[#2A3B4C]">
              <animate
            ...
            <circle
              ...
              cy="30"
              r="1.5"
              className="fill-[#45B7D1] dark:fill-[#56CFE1]"
            >
              <animate
                attributeName="opacity"
                values="0.5;1;0.5"
            ...
            <circle cx="80" cy="50" r="1" className="fill-[#2A3B4C]">
              <animate
                attributeName="opacity"
                values="0.2;0.8;0.2"
                dur="3s"
