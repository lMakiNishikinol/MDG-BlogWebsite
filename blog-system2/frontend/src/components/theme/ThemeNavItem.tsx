    ...
    >
      ...
      >
        ...
        >
          ...
          {/* 自动模式指示器 */}
          {autoMode && (
            <div className="absolute top-0 right-0 w-2.5 h-2.5 bg-[#45B7D1] rounded-full flex items-center justify-center animate-pulse z-20">
            ...
            <AnimatePresence mode="wait" initial={false}>
              {theme === "dark" ? (
                ...
                >
                  ...
                  <div className="w-full h-full bg-gradient-to-b from-[#45B7D1] to-[#7FD3F2] rounded-full flex items-center justify-center relative">
                    {/* Sun */}
                    <motion.div
                      initial={{ y: 6 }}
                      animate={{ y: 0 }}
          ...
          >
            <path
              ...
              stroke={
                autoMode ? "#45B7D1" : theme === "dark" ? "#56CFE1" : "#45B7D1"
              }
              strokeWidth="0.7"
              fill="none"
              className={
