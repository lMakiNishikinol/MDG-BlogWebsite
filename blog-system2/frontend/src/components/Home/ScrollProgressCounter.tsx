      ...
      {isScrolled && isVisible ? (
        ...
        >
          <motion.button
            ...
            className={cn(
              "cursor-target flex items-center justify-center overflow-hidden",
              "bg-gradient-to-r from-[#2A3B4C] to-[#45B7D1] dark:from-[#3A7D8A] dark:to-[#56CFE1]",
            ...
            <AnimatePresence mode="wait">
              {isAtBottom ? (
                <motion.div
                  ...
                  className="flex items-center justify-center px-2 py-0.5 whitespace-nowrap"
                >
